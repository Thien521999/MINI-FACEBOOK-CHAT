<?php
    ...
    // REQUEST NOTIFICATION NUMBER(số thông báo)
    $get_req_num = $frnd_obj->request_notification($_SESSION['user_id'], false);
    // TOTAL FRIENDS(tông số friend)
    ...
    <div class="profile_container">     
        ...
        <nav>
            <ul>
                ...
                <li><a href="friends.php" rel="noopener noreferrer">Users<span class="badge"><?php echo $get_frnd_num;?></span></a></li>
            </ul>
        </nav>
        <div class="all_users">
            <h3>All Users</h3>
